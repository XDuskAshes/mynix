    ...
    programs.firefox = {
        ...
        policies = {
            ...
            in {
                ...
                "uBlock0@raymondhill.net" = { # uBlock Origin - https://ublockorigin.com/
                    install_url = moz "ublock-origin";
                    installation_mode = "force_installed";
                    default_area = "navbar";
                };
                "jid1-MnnxcxisBPnSXQ@jetpack" = { # Privacy Badger - https://privacybadger.org/
                ...
                "sponsorBlocker@ajay.app" = { # SponsorBlock - https://sponsor.ajay.app/
                    install_url = moz "sponsorblock";
                    installation_mode = "force_installed";
                };
                "{34daeb50-c2d2-4f14-886a-7160b24d66a4}" = { # Youtube-shorts Block - https://github.com/doma-itachi/Youtube-shorts-block
                    install_url = moz "youtube-shorts-block";
                    installation_mode = "force_installed";
                };
                "{762f9885-5a13-4abd-9c77-433dcd38b8fd}" = { # Return Youtube Dislike - https://returnyoutubedislike.com/
